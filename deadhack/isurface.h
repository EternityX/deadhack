...
public:
	void DrawSetColor( Color color ) {
		...
		Utils::get_method<original_fn>( this, 14 )( this, color );
	}
	void DrawFilledRect( int x0, int y0, int x1, int y1 ) {
		using original_fn = void( __thiscall * )( void *, int, int, int, int );
		Utils::get_method<original_fn>( this, 16 )( this, x0, y0, x1, y1 );
	}
	void DrawLine( int x0, int y0, int x1, int y1 )
	{
		using original_fn = void( __thiscall * )( void *, int, int, int, int );
		Utils::get_method<original_fn>( this, 19 )( this, x0, y0, x1, y1 );
	}
};
