...
public:
	int get_item_definition_index() {
		return *(int *)( (ulong_t)this + g_offsets.m_iItemDefinitionIndex );
	}
	...
	float get_grenade_throw_strength() {
		return *(float *)( (ulong_t)this + g_offsets.m_flThrowStrength );
	}

	bool get_pin_pulled() {
		return *(bool *)( (ulong_t)this + g_offsets.m_bPinPulled );
	}

	float get_spread() {
		return Utils::get_method< float( __thiscall *)( decltype( this ) )>( this, 439 )( this );
	}
	...
	float get_inaccuracy() {
		return Utils::get_method< float( __thiscall *)( decltype( this ) )>( this, 469 )( this );
	}

	void update_accuracy_penalty() {
		Utils::get_method< void( __thiscall *)( decltype( this ) )>( this, 470 )( this );
	}
